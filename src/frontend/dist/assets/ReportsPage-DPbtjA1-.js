import { o, r as reactExports, v as vt, u as useAuth, j as jsxRuntimeExports, e as CardSkeleton } from "./index-JOqAemMk.js";
...
function ReportCard({
  ...
  const onShare = reactExports.useCallback(async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-5 h-5 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground truncate leading-snug", children: report.filename }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-x-2 gap-y-0.5 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-primary font-medium bg-primary/8 px-1.5 py-0.5 rounded", children: report.patientId }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "badge-success", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: shared ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardCopy, { className: "w-3.5 h-3.5 text-accent" }),
                  "Copied!"
...
function DateGroup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
    ...
    items.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ReportCard,
      {
        report: r,
...
function ReportsPage() {
  ...
  const [searchQuery, setSearchQuery] = reactExports.useState(null);
  const { data: allReports = [], isLoading: isLoadingAll } = useQuery({
    queryKey: ["reports", user == null ? void 0 : user.token, user == null ? void 0 : user.userId],
    queryFn: () => api.getReportsByCenter(user.token, user.userId, null, null),
    enabled: !!(user == null ? void 0 : user.token) && !hasSearched
  });
  const { data: patientReports = [], isLoading: isLoadingPatient } = useQuery({
    queryKey: ["reports-patient", user == null ? void 0 : user.token, searchQuery == null ? void 0 : searchQuery.patientId],
    queryFn: () => api.getReportsByPatient(user.token, searchQuery.patientId),
    enabled: !!(user == null ? void 0 : user.token) && !!(searchQuery == null ? void 0 : searchQuery.patientId)
  });
  const isLoading = hasSearched ? isLoadingPatient : isLoadingAll;
  const baseReports = hasSearched && (searchQuery == null ? void 0 : searchQuery.patientId) ? patientReports : allReports;
  const filtered = dateFilter ? baseReports.filter((r) => toDateInputValue(r.uploadedAt) === dateFilter) : baseReports;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PartnerLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-6 flex flex-col gap-4", children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground pointer-events-none" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    id: "reports-date",
      ...
      hasSearched && ((searchQuery == null ? void 0 : searchQuery.patientId) || dateFilter) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
        (searchQuery == null ? void 0 : searchQuery.patientId) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 text-xs bg-primary/10 text-primary font-medium px-2.5 py-1 rounded-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-3 h-3" }),
          "ID: ",
          searchQuery.patientId
        ] }),
        dateFilter && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 text-xs bg-accent/10 text-accent font-medium px-2.5 py-1 rounded-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3 h-3" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground self-center", children: [
          filtered.length,
          " result",
          filtered.length !== 1 ? "s" : ""
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4", "data-ocid": "reports.list", children: isLoading ? ["s1", "s2", "s3"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(CardSkeleton, {}, k)) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        EmptyState,
        {
          icon: hasSearched ? /* @__PURE__ */ jsxRuntimeExports.jsx(FileSearch, { className: "w-7 h-7" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-7 h-7" }),
          title: hasSearched ? "No reports available" : "No reports yet",
          description: hasSearched ? "Try a different Patient ID or date range" : "Reports uploaded by the lab will appear here.",
