import { r as reactExports, j as jsxRuntimeExports, u as useAuth, C as CenterStatus, L as Link } from "./index-JOqAemMk.js";
import { c as createLucideIcon, u as useApiService, a as useQuery } from "./api-BJm7cS3U.js";
import { P as PartnerLayout, A as Activity } from "./PartnerLayout-BZ-tItP5.js";
import { F as FileText } from "./log-out-D-etv4XY.js";
import { T as TrendingUp } from "./trending-up-DJSH1_8f.js";
import { C as ClipboardList } from "./clipboard-list-uzcshydA.js";
...
function DashboardPage() {
  ...
  const { data: center } = useQuery({
    queryKey: ["myCenter", user == null ? void 0 : user.token],
    queryFn: () => api.getMyCenter(user.token),
    enabled: !!(user == null ? void 0 : user.token)
  });
  const isActive = (center == null ? void 0 : center.status) === CenterStatus.active;
  const displayName = (user == null ? void 0 : user.centerName) ?? (user == null ? void 0 : user.userId) ?? "Partner";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PartnerLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 pb-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "mb-5",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-xl text-foreground leading-snug", children: [
            "Welcome, ",
            displayName
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm", children: "Current Status:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                className: `text-sm font-semibold flex items-center gap-1.5 ${isActive ? "text-accent" : "text-destructive"}`,
                children: [
                  isActive ? "Active" : "Inactive",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `w-2 h-2 rounded-full ${isActive ? "bg-accent animate-pulse" : "bg-destructive"}`
                    }
                  )
                ]
              }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: STATS.map(({ label, value, icon: Icon, color: color2, bg }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            custom: i,
            initial: "hidden",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `w-4 h-4 ${color2}` })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-base text-foreground leading-none", children: value }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-[10px] text-center leading-tight font-medium", children: label })
            ]
          },
          label
        ))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", "data-ocid": "dashboard.menu_list", children: MENU_CARDS.map(
      ({ title, desc, icon: Icon, path, iconColor, iconBg, accent, cta }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          custom: i,
          initial: "hidden",
            ...
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm text-foreground leading-tight", children: title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-[11px] mt-0.5 leading-snug", children: desc })
                ] }),
                cta && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-full text-center text-xs font-semibold py-2 px-3 rounded-lg bg-accent text-accent-foreground transition-smooth group-hover:opacity-90", children: cta })
              ]
            }
          )
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-muted-foreground text-xs mt-8 mb-1", children: [
      "© ",
